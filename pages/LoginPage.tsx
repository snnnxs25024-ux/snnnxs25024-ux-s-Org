...
const LoginPage: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Status session akan otomatis berubah karena listener di App.tsx
    }
  };
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                >
                  {showPassword ? (
                    <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.057 10.057 0 012.183-3.643M8.952 8.952a4 4 0 105.096 5.096m-5.096-5.096L3 3m18 18l-3.875-3.875M15.75 14.25a3 3 0 00-4.5-4.5m-2.25 2.25L3 3" /></svg>
                  ) : (
